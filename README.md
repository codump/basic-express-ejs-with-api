...
* *If you only want to use these core packages select the minimal branch. We choose to make the deluxe version on the main branch to give you the most goodies by default. And it might be helpful for the new kids on the block.*
